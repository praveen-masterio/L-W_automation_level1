...
public class ScenariosTest extends BaseClass {
	...
	public void addLaptopToCartAndVerifySubTotal() {
		...
		ProductPage productPage = homePage.clickOnSecondProductResult();
		productPage.addProductToCart();
	...
	public void addTwoItemsToCartAndVerifySubTotal() {
		...
		Assert.assertEquals(headphonesPrice + keyboardPrice, cartSubTotal,
				"Product prices and cart sub total do not match");
	}
